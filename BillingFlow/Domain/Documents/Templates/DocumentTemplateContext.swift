...
struct DocumentTemplateContext {
    ...
    init(document: BusinessDocument) {
        ...
        self.currencySummaryText = ""
        self.subtotalLabel = "Подытог"
        self.subtotalText = formattedSubtotal
        self.vatRowHiddenClass = hasVAT ? "" : "vat-row--hidden"
        self.vatText = "НДС"
        self.vatAmountText = formattedVAT
        self.totalLabel = "Итого"
        self.totalText = formattedTotal
        self.summaryText = "Всего наименований \(totals.itemCount), на сумму \(formattedTotal)"
